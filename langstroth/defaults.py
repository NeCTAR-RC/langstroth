...
DATABASES = {
    ...
    'default': {
            ...
            'NAME': path.join(path.dirname(__file__), DEFAULT_DATABASE_NAME),
    ...
    'allocations_db': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': path.join(path.dirname(__file__), ALLOCATION_DATABASE_NAME),
...
#             'filename': '/var/log/langstroth',  # Create the log directory with the correct permissions by hand.
#         },
    },
    'loggers': {
        'django.request': {
