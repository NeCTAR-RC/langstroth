...
# Test intended to check that Python code produces the identical result
# to the database SQL code. 

# As the test depends on allocation_tree.json which contqins non-anonymised data
# the data file has been removed from the repo and the test disabled.
